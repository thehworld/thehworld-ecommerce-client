  ...
  return (
    <div>
      ...
      <p>• 10:00 AM – 6:00 PM Monday – Saturday. Excluding public holidays.
        ...
        <h3 style={{textAlign: "center",paddingTop: "20px"}}>SHIPPING CHARGES</h3>
        ...
        <p>• We ship products throughout India. The shipping rates vary according to the total cart value as
          ...
          <h3  style={{textAlign: "center",paddingTop: "20px"}}>For International Orders:</h3>
          <br />
          ...
          <h3 style={{textAlign: "center",paddingTop: "20px"}}>RETURNS & REFUNDS POLICY</h3>
          <br />
